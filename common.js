...
(function () {
  var NAV_ITEMS = [
    ...
    { key: "publications", label: "LIBRARY", href: "publications.html" },
    { key: "news", label: "NEWS", href: "news.html" },
    { key: "kuca", label: "KUCA", href: null },
    { key: "contact", label: "ABOUT US", href: "contact.html" }
  ];
  ...
  function renderHeader(active) {
    ...
    return (
      ...
      '<a class="logo" href="index.html"><img src="img/logo.png" alt="gguggum art centre"><span class="logo-text">art centre</span></a>' +
  ...
  function renderFooter() {
    return (
      ...
      '<button type="button" class="footer-name" id="gg-footer-name">gguggum art centre</button>' +
      ...
      '<a href="https://www.youtube.com/@gguggumartcentre" target="_blank" rel="noopener" aria-label="YouTube"><svg viewBox="0 0 24 24"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.95-1.97C18.88 4 12 4 12 4s-6.88 0-8.59.45a2.78 2.78 0 0 0-1.95 1.97A29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58 2.78 2.78 0 0 0 1.95 1.97C5.12 20 12 20 12 20s6.88 0 8.59-.45a2.78 2.78 0 0 0 1.95-1.97A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58ZM9.75 15.5v-7l6 3.5-6 3.5Z"/></svg></a>' +
      "</div>" +
      "</footer>" +
      "</div>"
    );
